...
const MyProfile = () => {
  ...
  const [userData, setUserData] = useState({
    name: "Wimalsha Vincent",
    image: assets.profile_pic,
    email: 'wimalsha2gmail.com',
    phone: '077 1223 333',
    address: {
      line1: "chilaw Rd",
      line2: "Colombo"
  ...
  return (
    <div className='max-w-lg flex flex-col gap-2 text-sm'>
      ...
      <hr className='bg-zinc-500 underline mt-3' />
      <div>
        <p className='text-neutral-500 underline mt-3'>CONTACT INFORMATION</p>
        <div className='grid grid-flow-col-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700'>
      ...
      <div>
        ...
        <div className='grid grid-flow-col-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700'>
          <p className='font-medium'>Gender</p>
          {
            ...
            : <p className='bg-gray-100'>{userData.gender}</p>
          }
          <p className='font-medium'>Birthday</p>{
            ...
            : <p className='bg-gray-100'>{userData.dob}</p>
          }
        </div>
      </div>
      <div className='mt-10'>
        {
          isEdit
          ? <button className='border border-primary px-8 py-2 rounded-full hover:bg-primary hover:text-white transition-all' onClick={()=>setIsEdit(false)}>Save Onformation</button>
