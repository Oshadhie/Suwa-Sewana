  ...
  return (
    <form action="" className='min-h-[80vh] flex items-center'>
      <div className='flex flex-col gap-3 m-auto items-start p-8 min-w-[340px] sm:min-w-96 border rounded-xl text-zinc-600 text-sm shadow-lg'>
        ...
        {
          state === "Sign Up"
          ? <p>Already have an account? <span onClick={()=>setSatate('Login')} className='text-primary cursor-pointer'>Login Here</span></p>
          : <p>Create and new account? <span onClick={()=>setSatate('Sign Up')} className='text-primary cursor-pointer'>Click here</span></p>
        }
      </div>
    </form>
